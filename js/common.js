...
$(document).ready(function() {
    ...
    $('#skillDPS').on('click', function() {
        $("#contentBox").load("skillDPS.html");
    });

    $('#familiarDPS').on('click', function() {
        $("#contentBox").load("familiarDPS.html");
    });

    $('#skillDamage').on('click', function() {
        $("#contentBox").load("skillDamage.html");
    });

    $('#familiarDamage').on('click', function() {
        $("#contentBox").load("familiarDamage.html");
    });

    $('#specAnalysis').on('click', function() {
        $("#contentBox").load("specAnalysis.html");
    });

    $('#cooldownEfficiency').on('click', function() {
        $("#contentBox").load("cooldownEfficiency.html");
    });

    // $("#skillDPS").trigger("click");
     $("#contentBox").load("skillDPS.html");
    // $("#familiarDPSBox").load("familiarDPS.html");
    // $("#skillDamageBox").load("skillDamage.html");
    // $("#familiarDamageBox").load("familiarDamage.html");
    // $("#specAnalysisBox").load("specAnalysis.html");
    // $("#cooldownEfficiencyBox").load("cooldownEfficiency.html");
